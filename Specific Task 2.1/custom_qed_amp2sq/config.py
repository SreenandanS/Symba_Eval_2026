"""Dataclass configuration for QED amplitude -> squared-amplitude experiments."""
...
@dataclass
class QEDAmp2SqConfig:
    model: ModelConfig = field(default_factory=ModelConfig)
    training: TrainingConfig = field(default_factory=TrainingConfig)
    data: DataConfig = field(default_factory=DataConfig)
    output_dir: str = "outputs/custom_qed_amp2sq"
    experiment_name: str = "qed_amp_to_sq"
    device: str = "auto"
