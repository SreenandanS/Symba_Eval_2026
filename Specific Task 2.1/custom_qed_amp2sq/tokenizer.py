"""Local tokenizer for QED squared-amplitude decoder targets."""
...
class AmplitudeTokenizer:
    ...
    def build_vocab(self, numerator_expressions: Sequence[str]) -> "AmplitudeTokenizer":
        ...
        lengths: list[int] = []
        for expr in numerator_expressions:
