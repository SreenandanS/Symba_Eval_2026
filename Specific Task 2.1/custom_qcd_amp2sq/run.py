"""CLI runner for the standalone amplitude -> squared-amplitude package."""
...
def smoke_test(
    ...
    corpus = load_amp2sq_corpus(
        data_dir,
        cache_dir="outputs/custom_qcd_amp2sq/smoke_cache",
...
def main():
    parser = argparse.ArgumentParser(
        description="Standalone canonical amplitude -> squared amplitude model",
    )
    parser.add_argument("--config", type=str, default=None)
    parser.add_argument("--smoke-test", action="store_true")
    parser.add_argument("--data-dir", type=str, default=".")
    parser.add_argument("--output-dir", type=str, default="outputs/custom_qcd_amp2sq")
    ...
    from .train import Amp2SqTrainer
